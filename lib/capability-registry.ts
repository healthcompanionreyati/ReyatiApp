...
export const capabilityRegistry = [
  ...
  { id: "outbound_communications", name: "Outbound communications", status: "foundation", supportedEnvironments: ["local"], permittedRoles: [], externalDependencies: ["Email provider", "SMS provider", "Approved templates"], responsibleOwner: owner, knownLimitations: "Resend adapter, signed invitations, and verified webhook processing are implemented but remain compile-time disabled.", safetyRegulatoryGate: "Domain, secret, consent, template, deliverability, and incident activation review.", lastValidatedAt: validated },
