...
export const foundationFlags = {
  ...
  medicalDocumentUploads: productionFlag("QIVAYA_MEDICAL_DOCUMENT_UPLOADS"),
  ...
  documentDeletionProcessor: productionFlag("QIVAYA_DOCUMENT_DELETION_PROCESSOR"),
  privateDocumentDelivery: productionFlag("QIVAYA_PRIVATE_DOCUMENT_DELIVERY"),
  documentUploadCleanup: productionFlag("QIVAYA_DOCUMENT_UPLOAD_CLEANUP"),
  documentScanRecovery: productionFlag("QIVAYA_DOCUMENT_SCAN_RECOVERY"),
  retentionAutomationExecution: productionFlag("QIVAYA_RETENTION_AUTOMATION_EXECUTION"),
