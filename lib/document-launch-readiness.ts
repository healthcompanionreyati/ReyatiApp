...
export async function getDocumentLaunchReadiness(userId: string, now = new Date()) {
  ...
  const inputs: StageInput[] = [
    ...
    },
    {
      ...
      action: "Open governance handoff",
      actionAr: "فتح تسليم الحوكمة",
      href: "/admin/governance-handoff",
    ...
    },
    {
      ...
      href: "/admin/document-runtime-posture",
    ...
    },
    {
      ...
      href: "/admin/document-assurance-collection",
    ...
    },
    {
      ...
      href: "/admin/lifecycle-acceptance-submission",
