...
export async function getOperationsHealth(userId: string, operatorName: string) {
  ...
  const controls = [
    ...
    { id: "retention_enforcement", name: "Automated retention enforcement", status: "blocked", note: "A gated deletion processor and independently reviewed legal-hold workflow exist, but approved schedules and activation remain outstanding." },
