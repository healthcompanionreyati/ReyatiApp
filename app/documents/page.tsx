...
export default function MedicalDocumentsPage() {
  ...
  return <main className={`documents-shell ${ar ? "arabic" : ""}`} dir={ar ? "rtl" : "ltr"} id="main-content">
    ...
    <section className="documents-boundary"><span>i</span><div><b>{ar ? "رفع المستندات غير مفعّل بعد." : "Document uploads are not active yet."}</b><p>{ar ? "لن يفعّل رعايتي الرفع إلا بعد اجتياز التخزين المحمي وفحص البرمجيات الضارة والحجر وضوابط الاحتفاظ مراجعة التفعيل. لا يتم قبول أي ملف أو الادعاء بتخزينه اليوم." : "Reyati will enable uploads only after protected storage, malware scanning, quarantine, and retention controls pass activation review. No file is accepted or implied to be stored today."}</p></div></section>
