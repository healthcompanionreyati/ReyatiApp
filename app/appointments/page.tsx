...
export default function Appointments() {
  ...
  return <main className={`appointments-shell ${ar ? "arabic" : ""}`} dir={ar ? "rtl" : "ltr"} id="main-content">
    <header className="wallet-header"><a href="/" className="brand"><img src="/brand/reyati-logo.svg" alt="Reyati"/></a><nav><a href={providersPath}>{ar ? "ابحث عن رعاية" : "Find care"}</a><a className="active" href="/appointments">{ar ? "المواعيد" : "Appointments"}</a><a href="/wallet">{ar ? "المحفظة الصحية" : "Health wallet"}</a><a href="/payments">{ar ? "المدفوعات" : "Payments"}</a><a href="/support">{ar ? "الدعم" : "Support"}</a></nav><div><button className="lang" type="button" onClick={() => setLang(ar ? "en" : "ar")}>{ar ? "English" : "العربية"}</button><a href="/notifications" className="appointment-notification-link">●</a><span className="avatar">RY</span></div></header>
