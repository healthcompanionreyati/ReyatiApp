...
const routeTitles: Record<string, string> = {
  "/admin/operations": "System health centre",
  "/admin/pilot-activation": "Pilot activation centre",
  "/admin/pilot-participant-rehearsal": "Participant journey rehearsal",
...
const arabicRouteTitles: Record<string, string> = {
  "/admin/operations": "مركز صحة النظام",
  "/admin/pilot-activation": "مركز تفعيل البرنامج التجريبي",
  "/admin/pilot-participant-rehearsal": "بروفة رحلة المشارك",
...
const providerCareDeliveryDenseRoutes = new Set([
  "/provider/care-plans",
