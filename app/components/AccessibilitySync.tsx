...
const routeTitles: Record<string, string> = {
  ...
  "/admin/moderation": "Moderation boundary", "/admin/organizations": "Organizations", "/admin/verification": "Provider verification", "/admin/navigator-governance": "Care Navigator governance", "/admin/prescription-intelligence": "Prescription intelligence", "/admin/report-reader": "Medical Report Reader", "/admin/reminder-readiness": "Medication reminder readiness", "/admin/reminder-delivery-policy": "Medication reminder delivery policy", "/admin/reminder-activation-readiness": "Medication reminder activation readiness",
};
