...
const routeTitles: Record<string, string> = {
  ...
  "/benefits": "My benefits", "/partner/benefits": "Employer benefit operations", "/admin/benefits": "Benefit governance", "/reviews": "My reviews", "/provider/reviews": "Provider reviews", "/admin/reviews": "Review moderation", "/payment-support": "Payment support", "/admin/finance-controls": "Finance controls", "/admin/payment-reconciliation": "Payment reconciliation",
...
const arabicRouteTitles: Record<string, string> = {
  ...
  "/benefits": "مزاياي", "/partner/benefits": "عمليات مزايا صاحب العمل", "/admin/benefits": "حوكمة المزايا", "/reviews": "مراجعاتي", "/provider/reviews": "مراجعات مقدم الرعاية", "/admin/reviews": "إشراف المراجعات", "/payment-support": "دعم المدفوعات", "/admin/finance-controls": "الضوابط المالية", "/admin/payment-reconciliation": "مطابقة المدفوعات",
