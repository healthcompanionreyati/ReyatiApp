...
const routeTitles: Record<string, string> = {
  ...
  "/settings/accessibility": "Language and accessibility", "/admin/accessibility-settings": "Accessibility governance", "/facilities": "Facility directory", "/provider/facility-profile": "Facility profile", "/admin/facility-directory": "Facility directory governance", "/admin/release-controls": "Release controls",
  "/account/profile": "My profile", "/admin/patient-profiles": "Patient-profile governance", "/provider/organization-settings": "Organization settings", "/admin/tenant-configuration": "Tenant configuration", "/admin/policy-templates": "Policy and communication templates", "/service-status": "Service status", "/admin/service-status": "Service-status communications", "/provider/team-access": "Team and access governance", "/provider/schedule-rules": "Scheduling rules and impact", "/admin/provider-operations-governance": "Provider operations governance", "/partner/onboarding": "Partner onboarding and access", "/partner/settlements": "Partner settlement and reconciliation", "/admin/partner-governance": "Partner and settlement governance",
...
const arabicRouteTitles: Record<string, string> = {
  ...
  "/settings/accessibility": "اللغة وإمكانية الوصول", "/admin/accessibility-settings": "حوكمة إمكانية الوصول", "/facilities": "دليل المنشآت", "/provider/facility-profile": "ملف المنشأة", "/admin/facility-directory": "حوكمة دليل المنشآت", "/admin/release-controls": "ضوابط الإصدار",
  "/account/profile": "ملفي الشخصي", "/admin/patient-profiles": "حوكمة ملفات المرضى", "/provider/organization-settings": "إعدادات المؤسسة", "/admin/tenant-configuration": "حوكمة إعدادات المؤسسات", "/admin/policy-templates": "قوالب السياسات والاتصالات", "/service-status": "حالة الخدمات", "/admin/service-status": "اتصالات حالة الخدمة", "/provider/team-access": "حوكمة الفريق والوصول", "/provider/schedule-rules": "قواعد الجدولة والأثر", "/admin/provider-operations-governance": "حوكمة عمليات المزود", "/partner/onboarding": "إعداد الشريك والوصول", "/partner/settlements": "تسوية الشريك والمطابقة", "/admin/partner-governance": "حوكمة الشركاء والتسوية",
