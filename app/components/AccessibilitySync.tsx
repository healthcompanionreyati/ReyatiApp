...
const routeTitles: Record<string, string> = {
  "/": "Home", "/navigator": "Care Navigator", "/providers": "Find care", "/appointments": "Appointments", "/virtual-care": "Virtual care", "/messages": "Secure messages", "/wallet": "Health records", "/medication-reminders": "Medication reminders",
  ...
  "/provider/insights": "Provider insights", "/provider/encounter": "Encounter workspace", "/provider/virtual-care": "Provider virtual care", "/provider/messages": "Provider messages", "/partner": "Partner workspace",
  "/partner/program": "Partner programme", "/admin": "Operations overview", "/admin/access": "Platform access",
  "/admin/audit": "Audit ledger", "/admin/cases": "Support operations", "/admin/finance": "Finance operations", "/admin/messaging": "Messaging governance",
...
const arabicRouteTitles: Record<string, string> = {
  "/": "الرئيسية", "/navigator": "موجّه الرعاية", "/providers": "ابحث عن رعاية", "/appointments": "المواعيد", "/virtual-care": "الرعاية الافتراضية", "/messages": "الرسائل الآمنة", "/wallet": "السجلات الصحية", "/medication-reminders": "تذكيرات الدواء",
