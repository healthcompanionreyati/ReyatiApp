...
const routeTitles: Record<string, string> = {
  "/care-plan": "My care plans", "/provider/care-plans": "Provider care plans", "/admin/care-plans": "Care-plan governance", "/diagnostic-imaging": "Diagnostic imaging", "/provider/diagnostic-imaging": "Provider imaging orders", "/partner/diagnostic-imaging": "Imaging operations", "/admin/diagnostic-imaging": "Imaging governance", "/insurance": "Insurance and authorization", "/provider/insurance": "Provider authorizations", "/partner/insurance": "Payer operations", "/admin/insurance": "Insurance governance",
