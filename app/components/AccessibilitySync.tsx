...
const routeTitles: Record<string, string> = {
  ...
  "/account/profile": "My profile", "/admin/patient-profiles": "Patient-profile governance", "/provider/organization-settings": "Organization settings", "/admin/tenant-configuration": "Tenant configuration", "/admin/policy-templates": "Policy and communication templates", "/service-status": "Service status", "/admin/service-status": "Service-status communications", "/provider/team-access": "Team and access governance", "/provider/schedule-rules": "Scheduling rules and impact", "/admin/provider-operations-governance": "Provider operations governance",
...
const arabicRouteTitles: Record<string, string> = {
  ...
  "/account/profile": "ملفي الشخصي", "/admin/patient-profiles": "حوكمة ملفات المرضى", "/provider/organization-settings": "إعدادات المؤسسة", "/admin/tenant-configuration": "حوكمة إعدادات المؤسسات", "/admin/policy-templates": "قوالب السياسات والاتصالات", "/service-status": "حالة الخدمات", "/admin/service-status": "اتصالات حالة الخدمة", "/provider/team-access": "حوكمة الفريق والوصول", "/provider/schedule-rules": "قواعد الجدولة والأثر", "/admin/provider-operations-governance": "حوكمة عمليات المزود",
