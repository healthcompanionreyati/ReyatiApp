...
const routeTitles: Record<string, string> = {
  ...
  "/account/profile": "My profile", "/admin/patient-profiles": "Patient-profile governance", "/provider/organization-settings": "Organization settings", "/admin/tenant-configuration": "Tenant configuration", "/admin/policy-templates": "Policy and communication templates", "/service-status": "Service status", "/admin/service-status": "Service-status communications",
...
const arabicRouteTitles: Record<string, string> = {
  ...
  "/account/profile": "ملفي الشخصي", "/admin/patient-profiles": "حوكمة ملفات المرضى", "/provider/organization-settings": "إعدادات المؤسسة", "/admin/tenant-configuration": "حوكمة إعدادات المؤسسات", "/admin/policy-templates": "قوالب السياسات والاتصالات", "/service-status": "حالة الخدمات", "/admin/service-status": "اتصالات حالة الخدمة",
