...
export async function GET() {
  try {
    ...
    return Response.json({ data: await getPartnerCapabilityBoundary(user.id, user.displayName) }, { headers: noStore });
  } catch (error) {
    ...
    console.error("Unable to load partner capability boundary", error);
