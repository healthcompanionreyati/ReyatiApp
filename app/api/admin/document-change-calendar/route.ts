...
export async function GET() { return handleDocumentProductionOperationsRoute((userId) => getDocumentProductionOperationsWorkspace(userId, "change_calendar"), "admin.document_change_calendar"); }
