...
export async function GET() { return handleDocumentProductionOperationsRoute((userId) => getDocumentProductionOperationsWorkspace(userId, "incident_watch"), "admin.document_incident_watch"); }
