...
export async function GET() { return handleDocumentProductionOperationsRoute((userId) => getDocumentProductionOperationsWorkspace(userId, "resilience_scorecard"), "admin.resilience_scorecard"); }
