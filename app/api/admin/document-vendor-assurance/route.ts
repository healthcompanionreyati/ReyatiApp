...
export async function GET() { return handleDocumentProductionOperationsRoute((userId) => getDocumentProductionOperationsWorkspace(userId, "vendor_assurance"), "admin.document_vendor_assurance"); }
