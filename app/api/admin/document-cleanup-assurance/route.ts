...
export async function GET() { return handleDocumentProductionOperationsRoute((userId) => getDocumentProductionOperationsWorkspace(userId, "cleanup_assurance"), "admin.document_cleanup_assurance"); }
