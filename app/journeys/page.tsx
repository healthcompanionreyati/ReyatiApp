...
const journeys=[
  ...
  {group:"operations",href:"/admin/finance",icon:"Q",title:"Finance operations",titleAr:"العمليات المالية",text:"Settlements, reconciliation, refunds, and ledger controls",textAr:"التسويات والمطابقة والاستردادات وضوابط الدفتر",status:"Restricted"},
  {group:"operations",href:"/admin/cases",icon:"◇",title:"Cases & escalations",titleAr:"الحالات والتصعيدات",text:"Triage, ownership, SLA controls, evidence, and resolution",textAr:"الفرز والملكية وضوابط الخدمة والأدلة والحل",status:"Restricted"},
  {group:"operations",href:"/admin/moderation",icon:"◉",title:"Review moderation",titleAr:"إشراف التقييمات",text:"Privacy redaction, content integrity, policy decisions, and safety routing",textAr:"تنقيح الخصوصية ونزاهة المحتوى وقرارات السياسة ومسار السلامة",status:"Restricted"},
  {group:"operations",href:"/admin/audit",icon:"▤",title:"Audit & security",titleAr:"التدقيق والأمن",text:"Privileged access, anomaly monitoring, policy posture, and evidence",textAr:"الوصول المميز ومراقبة الشذوذ ووضع السياسات والأدلة",status:"Restricted"},
