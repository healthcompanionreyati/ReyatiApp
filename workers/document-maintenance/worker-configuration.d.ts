/* eslint-disable */
// Generated by Wrangler by running `wrangler types workers/document-maintenance/worker-configuration.d.ts --config wrangler.document-maintenance.jsonc` (hash: 3170d0a1aebed15a035ec149e6081aa1)
// Runtime types generated with workerd@1.20260515.1 2026-08-22 nodejs_compat
interface __BaseEnv_Env {
	UPLOAD_CLEANUP_URL: "https://www.qivaya.com/api/internal/document-upload-cleanup";
	SCAN_RECOVERY_URL: "https://www.qivaya.com/api/internal/document-scan-recovery";
	SCAN_POLL_URL: "https://www.qivaya.com/api/internal/document-scan-poll";
	RETENTION_ENFORCEMENT_URL: "https://www.qivaya.com/api/internal/document-retention-enforcement";
	SCAN_POLL_ENABLED: "false";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "UPLOAD_CLEANUP_URL" | "SCAN_RECOVERY_URL" | "SCAN_POLL_URL" | "RETENTION_ENFORCEMENT_URL" | "SCAN_POLL_ENABLED" | "RETENTION_ENFORCEMENT_ENABLED">> {}
}
