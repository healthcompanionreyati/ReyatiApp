/* eslint-disable */
// Generated by Wrangler by running `wrangler types workers/document-maintenance/worker-configuration.d.ts --config wrangler.document-maintenance.jsonc` (hash: 80491fb69efc085f7b1cb5661c3d5d46)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "UPLOAD_CLEANUP_URL" | "SCAN_RECOVERY_URL" | "SCAN_POLL_URL" | "RETENTION_ENFORCEMENT_URL">> {}
}
