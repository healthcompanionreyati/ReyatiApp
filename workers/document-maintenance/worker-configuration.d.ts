/* eslint-disable */
// Generated by Wrangler by running `wrangler types workers/document-maintenance/worker-configuration.d.ts --config wrangler.document-maintenance.jsonc` (hash: 40d78cfa98b4d6f50e309ef12684e4e8)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "UPLOAD_CLEANUP_URL" | "SCAN_RECOVERY_URL" | "SCAN_POLL_URL">> {}
}
