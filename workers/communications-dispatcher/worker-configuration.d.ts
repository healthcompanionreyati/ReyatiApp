/* eslint-disable */
// Generated by Wrangler by running `wrangler types workers\communications-dispatcher\worker-configuration.d.ts --config wrangler.communications.jsonc --env-file work\communications-empty.env` (hash: 674cb5383f4129c35648f54e4cca786c)
// Runtime types generated with workerd@1.20260515.1 2026-08-22 nodejs_compat
interface __BaseEnv_Env {
	DISPATCH_URL: "https://www.qivaya.com/api/internal/communications/dispatch";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DISPATCH_URL">> {}
}
